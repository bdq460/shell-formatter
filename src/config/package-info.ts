...
export class PackageInfo {
    ...
    static get commandResetPerformanceMetrics(): string {
        return (
            ...
            )?.command || "shell-formatter.resetPerformanceMetrics"
        );
    }
     ...
     */
    static get commandShowPluginStatus(): string {
        return (
            packageJson.contributes?.commands?.find((c: Command) =>
                c.command?.includes("showPluginStatus"),
            )?.command || "shell-formatter.showPluginStatus"
        );
    }
