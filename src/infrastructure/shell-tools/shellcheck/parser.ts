...
import { LinterIssue, ToolCheckResult } from "../types";
 ...
 * @returns 工具结果
 */
export function parseShellcheckOutput(result: ExecutionResult): ToolCheckResult {
    let toolResult: ToolCheckResult = {};
