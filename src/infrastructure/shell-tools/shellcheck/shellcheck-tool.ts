...
import { CancellationToken, ExecutionResult, execute } from "../../../utils/executor";
import { ToolCheckResult } from "../types";
...
export class ShellcheckTool {
     ...
     * 检查 Shell 脚本
     */
    async check(options: ShellcheckOptions): Promise<ToolCheckResult> {
