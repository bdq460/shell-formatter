...
class TestPlugin extends BasePlugin {
    ...
    async testAsyncOperation(): Promise<string | undefined> {
        return await this.safeExecute(async () => {
            return 'success';
        }, 'testAsyncOperation');
    }

    async testAsyncOperationWithError(): Promise<string | undefined> {
        return await this.safeExecute(async () => {
            throw new Error('Test error');
        }, 'testAsyncOperationWithError');
    }

    async testAsyncOperationWithDefault(): Promise<string> {
        return await this.safeExecuteWithDefault(
            async () => {
                throw new Error('Test error');
            },
            'default-value',
            'testAsyncOperationWithDefault'
        );
    }

    getTestDependencies(): PluginDependency[] {
        return [
...
describe('BasePlugin', () => {
    ...
    describe('safeExecuteWithDefault', () => {
        ...
        it('should return operation result on success', async () => {
            const result = await plugin['safeExecuteWithDefault'](
                async () => 'success',
                'default',
                'test'
            );
