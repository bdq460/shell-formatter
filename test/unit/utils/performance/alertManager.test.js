...
import { AlertLevel, PerformanceAlertManager, getAlertManager, resetAlertManager, setAlertManager, } from '../../../../src/utils/performance/alertManager';
describe('PerformanceAlertManager', () => {
    ...
    describe('onAlert', () => {
        ...
        it('should register async alert handler', async () => {
            const handler = jest.fn(async (alert) => {
